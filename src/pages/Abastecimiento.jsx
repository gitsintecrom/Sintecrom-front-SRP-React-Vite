...
const Abastecimiento = () => {
  ...
  const handleAbastecer = (row) => {
    // Validar que Kg.Balanza sea mayor a 0
    const kilosBalanza = parseFloat(row.Kilos_Balanza) || 0;
    if (kilosBalanza <= 0) {
      Swal.fire({
        title: 'Atención',
        text: 'Debe registrar el peso en balanza antes de abastecer.',
        icon: 'warning',
    ...
    Swal.fire({
      title: '¿Confirmas el abastecimiento?', 
      text: `Serie/Lote: ${row.Origen_Lote}`, 
      icon: 'question', 
      showCancelButton: true, 
      confirmButtonColor: '#28a745', 
      confirmButtonText: 'Sí, abastecer', 

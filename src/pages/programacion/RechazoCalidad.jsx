// // /src/pages/programacion/RechazoCalidad.jsx (Código Completo)
...
//           await axiosInstance.post('/rechazos/reprogramar', { 
//             operacionId: row.Operacion_ID,
//             loteIDS: row.Lote_IDS,
//             sobrante: row.Sobrante, // El backend se encarga de convertir el texto a número
//             codigo: row.Codigo
//           });

//           Swal.close();
//           Swal.fire('¡Éxito!', 'La operación ha sido marcada.', 'success');
//           fetchRechazos(); // Refrescar la tabla
//         } catch (error) {
//           Swal.close();
...
// // /src/pages/programacion/RechazoCalidad.jsx (Versión Final con Filtro en Frontend)
...
//           const loteIdToSend = row.Lote_IDS || null;
...
//           // Se envía la orden al backend. Confiamos en que si no hay error, fue exitosa.
//           await axiosInstance.post('/rechazos/reprogramar', payload);

//           Swal.close();
//           Swal.fire('¡Éxito!', 'La operación ha sido marcada.', 'success');
          
//           // La única solución viable: actualizar la UI eliminando la fila del estado local.
//           setRechazos(prevRechazos => prevRechazos.filter(r => r.Operacion_ID !== row.Operacion_ID));
...
// // /src/pages/programacion/RechazoCalidad.jsx (VERSIÓN FINAL COMPLETA PARA REEMPLAZAR)
...
//           const loteIdToSend = row.Lote_IDS || null;
//           // El campo Sobrante viene del SP, no de la UI, así que lo usamos directamente.
//           const sobranteValue = row.Sobrante;
...
//           // ESTA ES LA LÓGICA CORRECTA Y FINAL: Refrescar desde la fuente de verdad.
//           fetchRechazos();

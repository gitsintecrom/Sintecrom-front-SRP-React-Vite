// src/pages/OperacionesPlancha.jsx
...
const OperacionesPlancha = () => {
  ...
  const columns = useMemo(() => [
    ...
    { name: 'Serie/Lote', selector: row => (row.Origen_Lote || '').substring(0, 11), width: '100px' },
    { name: 'Cortes', selector: row => row.Operacion_Cuchillas || '', width: '120px' },
    { 
      name: 'Prog', 
      selector: row => {
    ...
    { name: 'Abas', cell: row => row.Abastecida === '0' ? 'OK' : '', width: '60px', align: 'center' },
    { name: 'Op.Ant.', cell: row => row.OpAnterior || '', width: '80px', align: 'center' },
    { name: 'Cali', cell: row => <CaliIcon iconType={row.caliIcon} />, width: '60px', align: 'center' },
    { 
      name: 'Ancho', 
      selector: row => {
    ...
    { name: 'Flia.', selector: row => row.Familia || '', sortable: true, width: '70px', align: 'center' },
    { 
      name: 'Esp.', 
      selector: row => {
    ...
    { 
      name: 'Fecha Inicio', 
      selector: row => row.batch_FechaInicio || 'N/A', 
    ...
    { name: 'Tarea', selector: row => row.Tarea || '', width: '80px' },
    { name: 'Paq/Ata', selector: row => row.CantidadPaquetes || '0', width: '90px', align: 'center' },
    { name: 'Hoj/Roll', selector: row => row.CantidadRollos || '0', width: '90px', align: 'center' },
  ], [navigate]);
    ...
    <div className="content">
      <div className="container-fluid">
        <div className="d-flex justify-content-between align-items-center mb-3">
          <h1>SRP - Operaciones Pendientes Plancha {maquinaId}</h1>
...
export default OperacionesPlancha;
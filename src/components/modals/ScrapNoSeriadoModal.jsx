...
//         const agenteUrl = import.meta.env.VITE_AGENT_BALANZA_URL || 'http://localhost:12345';
//         const interval = setInterval(async () => {
//             // Si el usuario tiene el foco en el input, no sobreescribimos con la balanza
...
//         }, 1200);
//         return () => clearInterval(interval);
//     }, [isManualEdit]); // Se reinicia si cambia el modo de edición
...
//         try {
//             const nroEtiqueta = ''; // En scrap no seriado suele ir vacío o manual según tu lógica original
//             const atado = {
//                 atado: 1,
//                 rollos,
//                 peso,
...
//             await axiosInstance.post('/registracion/pesaje/reset', {
//                 operacionId,
//                 loteIds: 'EBCEC003-0D54-49C7-9423-7E41B3D11AE7', // ID fijo según tu código original
//                 sobrante: sobranteParam
//             });
//             setAtados([]);
//             setSobreOrdenTotal(0);
...
//         const confirm = Swal.fire({ title: '¿Eliminar?', showCancelButton: true });
//         if (!confirm.isConfirmed) return;
//         setAtados(prev => prev.filter((_, i) => i !== index));
//     };
...
//                         <input 
//                             type="number" 
//                             // Valor condicional para que no salte el cursor

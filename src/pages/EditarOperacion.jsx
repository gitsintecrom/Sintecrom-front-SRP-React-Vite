...
import SupervisorAuthModal from '../components/SupervisorAuthModal';
import NotasCalipsoModal from '../components/NotasCalipsoModal';
import PesajeModal from '../components/PesajeModal'; // Nuevo import
...
const EditarOperacion = () => {
    ...
    const [showNotasCalipsoModal, setShowNotasCalipsoModal] = useState(false);
    const [notasCalipso, setNotasCalipso] = useState('');
    const [showPesajeModal, setShowPesajeModal] = useState(false); // Nuevo estado para PesajeModal
    const [selectedLinea, setSelectedLinea] = useState(null); // Nuevo estado para la línea seleccionada
        ...
        <>
            <div className="detalle-container">
                <div className="main-content">
                    ...
                    <div className="detalle-body-container">
                        ...
                        <div className="grid-body">
                            {lineas.map((linea, index) => (
                                <div key={index} className="grid-row" style={{ cursor: 'pointer' }} onClick={() => {
            ...
            {showPesajeModal && selectedLinea && (
                <PesajeModal
                    ...
                    onSuccess={() => {
                        fetchData(); // Recargar grilla tras registrar pesaje
                    }}
                />
            )}
        </>

...
//         console.log('Row clicked:', row.Operacion_ID, row.status); // Depuración
//         if (row.status === 'EN_PROCESO') {
//             navigate(`/registracion/editar/${row.Operacion_ID}`, { state: { operationStatus: row.status } });
//         } else {
...
//                     onClick={(e) => {
//                         e.stopPropagation(); // Evita que el clic active onRowClicked
//                         navigate(`/registracion/detalle/${row.Operacion_ID}`, { state: { operationStatus: row.status } });
//                     }}
//                 >
//                     Ver
...
//             center: true 
//         },
//         // Eliminamos el botón "Editar" ya que la navegación se hace por clic en la fila
...
//     // Funciones del modal de pesaje (replicadas de Abastecimiento.jsx)
...
//                 }
//                 try {
//                     // *** CAMBIO CLAVE AQUÍ: Usar el mismo endpoint que Abastecimiento.jsx ***
...
//                 } catch (error) {
//                     console.error('Error al registrar la pesada en Operaciones:', error); // Log para depuración
...
//                 // podríamos llevarlo a la vista de detalle, aunque el requisito no lo especifica explícitamente para otros estados.
//                 // Para seguir la lógica previa a los cambios:
...
//                 </button>
//             ), 
//             ignoreRowClick: true, // Importante para que el clic del botón no propague a la fila
//             center: true 
//         },
//         { name: 'Tarea', selector: row => row.Tarea, sortable: true, wrap: true },
//         { name: 'Paq/Ata', selector: row => row.Paquetes, sortable: true, width: '80px', center: true },

...
//         if (!maquinaId) return;
//         setLoading(true);
//         axiosInstance.get(`/registracion/operaciones/slitter/${maquinaId}`)
//             .then(response => {
//                 setOperaciones(response.data || []);
//             })
//             .catch(error => {
//                 console.error("Error fetching slitter operations:", error);
//                 Swal.fire('Error', 'No se pudieron cargar las operaciones de Slitter.', 'error');
//             })
//             .finally(() => setLoading(false));
//     }, [maquinaId]);

//     const handleRowClick = (operacionId) => {
//         navigate(`/registracion/editar/${operacionId}`);
//     };
...
//             <h2>Operaciones Pendientes - Slitter {maquinaId}</h2>
...
//                 <tbody>
//                     {operaciones.map(op => (
//                         <tr key={op.Operacion_ID} onClick={() => handleRowClick(op.Operacion_ID)} style={{ cursor: 'pointer' }}>
//                             <td>{op.Operacion_ID}</td>
//                             <td>{op.Serie_Lote}</td>
//                             <td>{op.Cortes}</td>
//                             <td>{op.Programados}</td>
//                             <td>{op.Stock}</td>
//                             <td>{op.Balance}</td>
//                             <td>{op.Abastecida}</td>
//                             <td>{op.OpAnt}</td>
...
//                             <td><button className="btn btn-sm btn-info">Ver</button></td>
//                             <td>{op.Tarea}</td>
//                             <td>{op.PaqAta}</td>
//                             <td>{op.Hc}</td>
//                         </tr>

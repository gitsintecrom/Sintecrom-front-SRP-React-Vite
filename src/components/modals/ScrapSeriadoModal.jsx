// // src/components/modals/ScrapSeriadoModal.jsx
// // Igual que SobranteModal, pero con sobranteParam = 2 y flags de scrap
...
// const ScrapSeriadoModal = ({ lineaData, operacionId, onClose, onSuccess }) => {
...
//                 }
//             });
//             Swal.fire('Éxito', 'Scrap seriado registrado.', 'success');
//             onSuccess();
//             onClose();
//         } catch (err) {
//             console.error(err);
...
//                     <h3>Scrap Seriado - {lineaData?.Ancho} x {lineaData?.Cuchillas}</h3>
...
// export default ScrapSeriadoModal;
...
const ScrapSeriadoModal = ({ lineaData, operacionId, onClose, onSuccess }) => {
    ...
    useEffect(() => {
        const agenteUrl = import.meta.env.VITE_AGENT_BALANZA_URL || 'http://localhost:12345';
        const interval = setInterval(async () => {
            // Si el usuario está escribiendo manualmente, no actualizamos con la balanza
        ...
        return () => clearInterval(interval);
    }, [isManualEdit]); // Se reinicia si cambia el estado de edición manual
            ...
            <div className="pesaje-modal">
                ...
                <div className="modal-body">
                    ...
                    <div className="pesaje-section">
                        ...
                        <input 
                            type="number" 
                            // Valor condicional para que el cursor no salte mientras escribes
